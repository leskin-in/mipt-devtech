...
class NoteDeleteButton extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
            id: props.id
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'button',
            { className: 'noteHeaderDeleteButton', onClick: this.handleClick },
            'DELETE'
        );
    }
}

class Note extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
            header: props.header,
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'noteHeaderDate' },
                    this.state.date
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'noteHeaderDelete' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(NoteDeleteButton, { id: this.state.id })
                )
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
...
class NoteList extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
            qid: props.qid,
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { id: 'noteList' },
            this.state.notes.map(note => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Note, {
                header: note.header,
                body: note.body,
                date: note.date,
                id: note.id,
...
class NoteAddForm extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
            qid: props.qid
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'form',
            { className: 'addNote', onSubmit: this.handleSubmit },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'label',
                { className: 'addNoteHeader' },
                'Title:',
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', ref: input => this.inputHeader = input })
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'label',
                { className: 'addNoteBody' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', ref: input => this.inputBody = input })
            ),
...
class Page extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor() {
        ...
        this.state = {
            qid: '',
            noteList: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(NoteList, { qid: '' }),
            noteAddForm: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(NoteAddForm, { qid: '' })
        };
        this.handleSubmit = this.handleSubmit.bind(this);
    }
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'label',
                        { className: 'searchFormHeader' },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', ref: input => this.inputQid = input })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'submit', value: 'Get notes!' })
                )
            ),
            this.state.noteList,
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Page, null), document.getElementById('backbone-static'));
